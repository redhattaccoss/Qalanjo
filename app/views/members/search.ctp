<?php 
	$html->css("blue/search", "stylesheet", array("inline"=>false));
?>
	        ...
	        <div class="left-container-box left">
	            <div class="bottom-container-box left">
	                ...
	                <div class="form-box left">
	                    <?php 
	                    	echo $form->create("Member", array("url"=>"/members/search_result"));
	                    ?>
	                        <fieldset>
	                            <div class="magnifier">
	                            </div>
	                            ...
	                            <div class="left">
	                                ...
	                                <?php 
	                                	...
	                                	echo $form->input("Member.age_from", array("type"=>"select", "div"=>false, "label"=>false, "options"=>$options,"selected"=>null, "class"=>"select45 left"));
	                                ...
	                                <?php 
	                                	...
	                                	echo $form->input("Member.age_to", array("type"=>"select", "div"=>false, "label"=>false, "options"=>$options,"selected"=>"60", "class"=>"select45 left"));
	                            ...
	                            <div class="divider">
	                                <div class="left">
	                                    ...
	                                    <br/>
	                                    <?php 
	                                    	echo $form->input("Member.distance_id", array("type"=>"select", "options"=>$distances, "div"=>false, "label"=>false, "class"=>"select203 left"));
	                                    ?>
	                                    <label class="spacing left">
	                                        of
	                                    </label>
	                                ...
	                                <div class="form-box-width-3 left">
	                                    ...
	                                    <br/>
	                                    <?php 
	                                    	echo $form->input("Member.country_id", array("type"=>"select", "options"=>$countries, "div"=>false, "label"=>false, "class"=>"select203 left"));
	                                    ?>
	                                </div>
	                                <div class="form-box-width-4 left">
	                                    ...
	                                    <br/>
	                                    <?php 
	                                    	echo $form->input("Member.state", array("type"=>"select", "options"=>$states, "div"=>false, "label"=>false, "class"=>"select203 left"));
	                                    ?>
	                                </div>
	                                <div class="left">
	                                    <?php 
	                                    	echo $form->input("online_now", array("type"=>"checkbox", "div"=>false, "label"=>false));
	                                    ?>
	                                    <label>
	                                        Online Now
	                                    </label>
                			...
                			<li>
                				<?php 
				                	if (isset($member["MemberProfile"]["picture_path"])||($member["MemberProfile"]["picture_path"]!="")){
										echo $html->image("uploads/".$member["Member"]["id"]."/default/profile_thumb_".$member["MemberProfile"]["picture_path"], array("url"=>"/members/profile/".$member["Member"]["id"], "class"=>"left"));
									}else{
										if ($member["Gender"]["value"]=="Man"){
											echo $html->image($path."default.jpg", array("url"=>"/members/profile/".$member["Member"]["id"]));
										}else{
											echo $html->image($path."woman-default-picture.jpg", array("url"=>"/members/profile/".$member["Member"]["id"]));
										}
									}
                				...
                				<div class="newest-member-profile left">
                        			<p>
                        				 <span class="newest-member-name"><?php echo $html->link($member["Member"]["firstname"]." ".$member["Member"]["lastname"], "/profile/".$member["Member"]["id"])?></span>
                        				 <br/>
                        				<?php 
	        ...
	        <div class="ads-wrapper">
	            <div class="ads-section-box-col1 left">
	                <h4>Ads title goes here...........</h4>
	               	<?php 
	               		echo $html->image("/css/img/blue/search/ad-image-small.gif", array("class"=>"left", "alt"=>""));	               		
	               	?>
