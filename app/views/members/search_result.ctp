        ...
        <div class="right">
	        <div class="right-container left">
	            ...
	            <h2>Refine Your Search</h2>
	             <?php 
	             	echo $form->create("Member", array("url"=>"/members/search_result", "id"=>"search-form"));
                 ?>
	                    ...
	                    <div class="left">
	                        ...
	                        <br/>
	                         <?php 
                                ...
                                echo $form->input("Member.age_from", array("type"=>"select", "div"=>false, "label"=>false, "options"=>$options,"selected"=>null, "class"=>"select46 left"));	
                              ?>
	                        <label class="spacing left">
	                            and 
	                        </label>
	                        <?php 
	                        	echo $form->input("Member.age_to", array("type"=>"select", "div"=>false, "label"=>false, "options"=>$options,"selected"=>null, "class"=>"select46 left"));
	                        ?>
	                    </div>
	                    <div class="divider">
	                    </div>
