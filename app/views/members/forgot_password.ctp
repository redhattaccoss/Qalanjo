...
<div class="left forgot-main-container">
	<?php echo $form->create("Member", array("id"=>"forgot", "url"=>"/members/forgot_password"))?>
				...
				<li>
					...
					<div class="label" id="emails">
						<dl class="choice">
							...
							<dd>
							<?php echo $form->input("forgot_email", array("class"=>"email", "id"=>"email-text", "div"=>false, "label"=>false))?>
							</dd>
						</dl>
						<hr/>
					</div>
				...
				<li>
					...
					<div class="label" id="alterns">
						<dl class="choice">
							...
							<dd>
							<?php echo $form->input("alternate_email", array("class"=>"email", "id"=>"altern-email-text", "div"=>false, "label"=>false))?>
							</dd>	
						</dl>
					</div>
				</li>
	...
	<?php 
	echo $form->input("state", array("type"=>"hidden", "id"=>"state"));	
	echo $form->end()?>
</div>
