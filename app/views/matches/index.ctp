<div class="content-container">
	<div class="matches-page-header">
		...
		<ul>
			<li>
				<?php echo $html->link("Find New Matches", "/matches")?>&nbsp;|&nbsp;
			</li>
			<li>
				<?php echo $html->link("Edit Match Settings", "/members/match_settings")?>
			</li>
		</ul>
	</div>
	<div class="main-content">
		...
		<div class="search-bar">
			<?php 
				echo $form->create("Match", array("id"=>"search_form"));			
				echo $form->input("search", array("div"=>false, "label"=>"Search:", "id"=>"search_match"));
				echo $form->button("Search", array("type"=>"submit", "div"=>false));
			?>
		...
		?>
				<div class="banner">
					<?php echo $html->image("designs/blue/matches/encourage.jpg")?>
				</div>
		<?php 
			}
		?>
