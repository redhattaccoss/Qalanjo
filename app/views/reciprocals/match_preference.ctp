...
<div class="item-set-content left">
	<?php echo $form->create("MemberReciprocalWeight", array("url"=>"/reciprocals/match_preference/".$page))?>
		<?php 
			$i = 0;
			$j=0;
						...
						<?php 
							foreach($temp as $temps){
								...
								?>
									...
									<div>
										<?php 
											echo $form->input("MemberReciprocalWeight.$j.weight", array("type"=>"radio", "before"=>"<label>", "separator"=>"</label><label>", "after"=>"</label>", "options"=>$options, "legend"=>false, "div"=>false, "label"=>false));
											echo $form->input("MemberReciprocalWeight.$j.member_id", array("type"=>"hidden", "value"=>$member_id));
											echo $form->input("MemberReciprocalWeight.$j.reciprocal_id", array("type"=>"hidden", "value"=>$temps["Reciprocal"]["id"]));
										?>
