...
<div class="messages">
		...
		<div class="right qmail-control-items">
			<ul>
				<li class="divider">
					<?php 
						if ($option=="all"){
							echo $html->link("Delete", "/receive_messages/delete_selected", array("class"=>"delete-batch"));
						}else{
							echo $html->link("Delete", "/receive_messages/delete_selected/trash", array("class"=>"delete-batch"));
						}
					?>
				</li>
				<li>
	...
	<?php echo $form->create("ReceiveMessage", array("class"=>"selector"));?>
		...
		?>
			<div class="<?php echo $class?> message" id="message_<?php echo $message["ReceiveMessage"]["id"]?>">
				<ul>
					<li class="checkbox">
						<?php 
							echo $form->checkbox("checkbox.$i", array("value"=>$message["ReceiveMessage"]["id"], "class"=>"control_check", 'hiddenField' => false));	
						?>
					</li>
					<li class="from">
