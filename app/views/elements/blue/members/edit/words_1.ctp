<div class="profile-wizard-content">
	...
	<?php 
		echo $form->create('InMyOwnWordsAnswer',array('url'=>"/members/edit/sk:$sk/page:$page"));
	?>
						...
						<?php		
							...
							foreach($this->data["InMyOwnWordsAnswer"] as $answer){
								if ($answer["in_my_own_words_question_id"]==$question["InMyOwnWordsQuestion"]["id"]){
									echo $form->input("InMyOwnWordsAnswer.$i.answer", array("div"=>false, "label"=>false, "value"=>$answer["answer"], "class"=>"answer-box"));
									$found=true;
								}
							}
							if (!$found){
								echo $form->input("InMyOwnWordsAnswer.$i.answer", array("div"=>false, "label"=>false));	
							}
							echo $form->input("InMyOwnWordsAnswer.$i.member_id", array("type"=>"hidden", "value"=>$member_id));
							echo $form->input("InMyOwnWordsAnswer.$i.in_my_own_words_question_id", array("type"=>"hidden", "value"=>$question["InMyOwnWordsQuestion"]["id"]));
							$i++;
						?>
