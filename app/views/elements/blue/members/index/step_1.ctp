...
<div class="form-content left">
	<?php echo $form->create("Member", array("url"=>"/members/step/1", "id"=>"step-1"))?>
	<?php echo $form->input("Member.id", array("type"=>"hidden"))?>
	<?php echo $form->input("MemberProfile.id", array("type"=>"hidden"))?>
		<div class="form-container left">
			<div class="form-profile left">
					<dl class="left">
						...
						<dd class="left">
							<?php 
								echo $form->input("Member.country_id", array("options"=>$countries, "div"=>false, "label"=>false, "id"=>"country","type"=>"select", "selected"=>"United States"));
							?>
						...
						<dd class="left">
							<?php 
								echo $form->input("Member.state", array("options"=>$states, "div"=>false, "label"=>false, "type"=>"select", "id"=>"state"));
							?>
							<label class="required clear">
                        	</label>
						</dd>
						...
						<dd class="left">
							<?php echo $form->input("Member.zipcode", array("class"=>"zipcode", "div"=>false, "label"=>false, "id"=>"zipcode"))?>
							<label class="required clear">
	                        </label>
						</dd>
