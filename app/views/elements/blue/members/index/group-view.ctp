...
<div class="left activity-content-block" id="communications-items">
	...
	<h3 class="left">
		<?php 
			echo $html->image($path."communication.png", array("class"=>"communication-icon left", "alt"=>""))									
		?>
...
<div class="left activity-content-block" id="gift-items">
	...
	<h3 class="left">
		<?php 
			echo $html->image($path."gift.png", array("class"=>"communication-icon left", "alt"=>""))									
		?>
...
<div class="left activity-content-block" id="communications-items">
	...
	<h3 class="left">
		<?php 
			echo $html->image($path."profile.png", array("class"=>"communication-icon left", "alt"=>""))									
		?>
...
<div class="left activity-content-block" id="communications-items">
	...
	<h3 class="left">
		<?php 
			echo $html->image($path."photo.png", array("class"=>"communication-icon left", "alt"=>""))									
		?>
...
<div class="left activity-content-block" id="wvme-items">
	...
	<h3 class="left">
		<?php 
			echo $html->image($path."lens.png", array("class"=>"communication-icon left", "alt"=>""))									
		?>
