<?php 
            			...
            			<div class="search-results-image left">
            				<?php 
			                	if (isset($member["MemberProfile"]["picture_path"])||($member["MemberProfile"]["picture_path"]!="")){
									echo $html->image("uploads/".$member["Member"]["id"]."/default/profile_thumb_".$member["MemberProfile"]["picture_path"], array("url"=>"/members/profile/".$member["Member"]["id"], "class"=>"image-border"));
								}else{
                ...
                <div class="search-results-name-box left">
                    <div class="icon right">
                        ...
                        <?php 
                        	echo $html->image("/css/img/blue/search/mail-icon.png", array("class"=>"left mail-icon"))
                        ?>
                        </a>
                        <a class="winker" id="wink_<?php echo $member["Member"]["id"]?>" href="#">
                        <?php 
                        	echo $html->image("/css/img/blue/search/smile-icon.png", array("class"=>"left smile-icon"))
                        ?>
                        </a>
                    </div>
