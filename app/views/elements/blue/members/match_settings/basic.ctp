<div class="content-container">
	...
	<div id="main-wrap">
			...
			<?php echo $form->create("Member", array("url"=>"/members/match_settings/basic"))?>	
			<?php echo $form->input("Member.id")?>
			<?php echo $form->input("MemberSetting.member_id", array("type"=>"hidden", "value"=>$member_id))?>
			...
			<div class="m-container left clear">
				...
				*/?>
				...
				<div class="choices">
					...
					<ul>
					<?php 		
						echo $form->input("MemberSetting.auto_archive",
							 array("legend"=>false,
							  "before"=>" <li>",
							  "after"=>" </li>",
							 "separator"=>"</li><li>",
