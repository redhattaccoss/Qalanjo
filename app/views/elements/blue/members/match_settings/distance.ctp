<div class="content-container">
	...
	<div id="main-wrap">
				...
				<?php echo $form->create("Member", array("url"=>"/members/match_settings/distance"))?>	
				...
				<div class="m-container left clear">
					<div id="distance" class="left">
							...
							<div class="span-5 clear">
								<?php 
									echo $form->input("Member.zipcode", array("div"=>false, "label"=>false, "class"=>"span-5 last"));
								?>
							</div>
							<div class="span-5 clear">
							...
							<div class="span-5 clear">
								<?php 
									echo $form->input("Member.city", array("div"=>false, "label"=>false, "class"=>"span-5 last"));
								?>					
							</div>
							...
							<div class="span-5 clear">
								<?php 
									echo $form->input("Member.country_id", array("div"=>false, "label"=>false, "options"=>$countries, "class"=>"span-5 last"));
								?>
							</div>
						</fieldset>										
					...
					<div id="how-far" class="left">
							...
							<div class="span-12 clear">
								<?php 
									echo $form->input("MemberSetting.distance_id", array("div"=>false, "label"=>false, "options"=>$distances, "class"=>"span-10 last"));
								?>
							</div>											
					</div>
				</div>
