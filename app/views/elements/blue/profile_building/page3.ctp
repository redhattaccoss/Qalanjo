<div class="item-set-content left">
					...
					<dd>
						<div class="radio-set">
							<?php 
								...
								echo $form->radio("MemberProfileAttributeWeight.educational_level_id", $options, array("legend"=>false, "separator"=>$separator, "before"=>$before, "hiddenField"=>false, "after"=>$after));
			...
			<li>
				<dl class="radio-set">
					...
					<dd>
						<div class="radio-set">
							<?php 
							echo $form->radio("MemberProfile.marital_status_id", $options, array("legend"=>false, "separator"=>$separator, "before"=>$before, "after"=>$after, 'hiddenField' => false));			
							?>
						</div>
					</dd>
				</dl>
        ...
        <ul class="block-set block-set-blue item-set-job">
			...
			<li>
				...
				<br />
				<?php 
       				echo $form->input("MemberProfile.occupation", array("id"=>"occupation", "div"=>false, "label"=>false))
       			?>	
			...
			<li>
				...
				<br />
				<?php 
					echo $form->input("MemberProfile.current_job", array("rows"=>"5", "cols"=>60,"div"=>false, "label"=>false));
				?>
			</li>
        </ul>
