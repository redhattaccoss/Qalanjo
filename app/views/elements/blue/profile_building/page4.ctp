			...
			<dl class="radio-set">
				...
				<dl>
					<div class="radio-set">
						<label>
							<?php 
								echo $form->input("MemberProfile.leisure_activity", array("rows"=>"5", "cols"=>60, "class"=>"Multilinebox",  "div"=>false, "label"=>false));
							?>
						</label>
						<br />
					</div>
			...
			<dl class="radio-set">
				...
				<dl>
					<div class="radio-set">
						...
						<label>
							<?php 
								echo $form->input("MemberProfile.passionate_about", array("rows"=>50, "cols"=>5, "class"=>"Multilinebox", "div"=>false, "label"=>false));
	                        ?>
						</label>
						<br />
					</div>
			...
			<dl class="radio-set">
				...
				<dl>
					<div class="radio-set">
						...
						<label>
							<?php 
								echo $form->input("MemberProfile.match_want", array("rows"=>50, "cols"=>5, "div"=>false, "class"=>"Multilinebox", "label"=>false));
	                        ?>
						</label>
						<br />
					</div>
