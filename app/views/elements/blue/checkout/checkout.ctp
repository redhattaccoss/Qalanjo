<?php 
	...
	if (!isset($url)){
		echo $form->create($model, array("class"=>"span-16", "id"=>"checkout"));
	}else{
		echo $form->create($model, array("class"=>"span-16", "id"=>"checkout", "url"=>$url));
	}
	echo $form->input("{$model}.price", array("type"=>"hidden", "value"=>$price));
	echo $form->input("{$model}.description", array("type"=>"hidden", "value"=>$description));
?>
	...
	<h2 class="header left">Checkout</h2>
		<fieldset class="basic-information left">
			...
			<div class="span-11 clear">
				<?php 
					echo $form->input("CreditCard.firstname", array("class"=>"span-8 last", "div"=>false, "label"=>false));
				?>											
			</div>
			...
			<div class="span-11 clear">
				<?php 
					echo $form->input("CreditCard.lastname", array("class"=>"span-8 last", "div"=>false, "label"=>false));
				?>					
			</div>
			...
			<div class="span-11 clear">
				<?php 
					echo $form->input("CreditCard.address1", array("class"=>"span-8 last", "div"=>false, "label"=>false));
				?>			
			</div>
		</fieldset>
</div>
...
<fieldset class="basic-information span-22 col-group left">
	<div class="col1 span-9 clear">
		...
		<div class="span-9 clear">
			<?php 
				echo $form->input("CreditCard.city", array("class"=>"span-8 last", "div"=>false, "label"=>false));
			?>						
		</div>
	...
	<div class="col1 span-9 left last">
		...
		<div class="span-10 clear">
			<?php 
				echo $form->input("CreditCard.zipcode", array("class"=>"span-8 last", "div"=>false, "label"=>false));
			?>					
		</div>
	</div>
	...
	<div class="col1 span-9 left">
		...
		<div class="span-9 clear">
			<?php 
				echo $form->input("CreditCard.state", array("class"=>"span-8 last", "div"=>false, "label"=>false));
			?>					
		</div>
	</div>
	...
	<div class="col1 span-9 left last">
		...
		<div class="span-9 clear">
			<?php 
				echo $form->input("CreditCard.country_id", array("type"=>"select", "selected"=>"236", "div"=>false, "label"=>false, "class"=>"span-8 last", "options"=>$countries));
			?>
		</div>
	</div>
</fieldset>
		...
		<div class="cc-form clear left">
			<h2>
				<span class="secured left">
					<?php 
						echo $html->image($path."lock.png", array("alt"=>"Secured Credit Card Payment"));
					?>
				</span>
			...
			<div class="span-11 clear">
				...
				<span class="left card active">
					<?php 
						echo $html->image("designs/creditcard/Visa.png", array("alt"=>"Visa"));
					?>
				</span>

				<span class="left card">
					<?php 
						echo $html->image("designs/creditcard/MasterCard.png", array("alt"=>"Master Card"));
					?>
				</span>

				<span class="left card">
					<?php 
						echo $html->image("designs/creditcard/Amex.png", array("alt"=>"American Express"));
					?>				
				</span>
				<?php 
					echo $form->input("{$model}.credit_type_id", array("type"=>"hidden", "id"=>"creditcardValue", "value"=>1));		
				?>
			</div>
			...
			<div class="span-11 clear">
				<?php echo $form->input("CreditCard.card_number", array("div"=>false, "label"=>false, "class"=>"span-8 last"))?>									
			</div>
			<div class="span-11 clear label">
			...
			<div class="span-11 clear">
				<?php 
					echo $form->month("CreditCard.expiration_month", "01", array("monthNames"=>false, "div"=>false, "empty"=>false));
				?> / 
				<?php 
					echo $form->year("CreditCard.expiration_year", date("Y")+1, date("Y")+5, date("Y")+1, array("div"=>false, "empty"=>false));
				?>			
			</div>
			<div class="span-11 clear label">
			...
			<div class="span-11 clear">
				<?php echo $form->input("CreditCard.cv_code", array("div"=>false, "label"=>false, "class"=>"small_sized"))?>			
			</div>
		</div>
