			...
			<div id="signup">
				...
				<div class="signup_form">
					<div  class="signup_form_container">
						<?php 
							echo $form->create("Member", array('inputDefaults'=>array('label'=>false, 'div'=>false), 'action'=>'signup', 'method'=>'POST', 'id'=>'signup_form2'));
						?>
						<label class="input">
						<span>Firstname</span>
						<?php 
							echo $form->input("Member.firstname", array("div"=>false, "label"=>false));
						?>
						</label>
						<label class="input">
						<span>Lastname</span>						
						<?php 
							echo $form->input("Member.lastname", array("div"=>false, "label"=>false));
						?>
						</label>
						<label class="input">
						<span>Email</span>	
						<?php 
							echo $form->input("Member.email", array("div"=>false, "label"=>false));
						?>
						</label>
						<?php 
							echo $form->button("<span>Find My Match!</span>", array('type'=>'submit'));
							echo $form->end();
						?>
					</div>
				</div>
			...
			<div id="login">
				<div id="login_form">
					<div class="login_form_container">
						...
						<?php 
							echo $form->create("Member", array('inputDefaults'=>array('label'=>false, 'div'=>false), 'action'=>'login', 'method'=>'POST', 'id'=>'login_form2'));
						?>
						<label class="input">
						<span>Email</span>	
						<?php 
						...
						<span>Password</span>	
						<?php 
							echo $form->input("Member.password", array('type'=>'password', "div"=>false, "label"=>false));
						?>
						</label>
						<?php 
							echo $form->button("<span>Login</span>", array('type'=>'submit'));
							echo $form->end();
						?>
